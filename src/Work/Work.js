    ...
    <div id="work" className="pageContainer workCont">
      ...
      <div className="projectCont">
        ...
        <div className="rightProject">
          ...
          <a className="buttonPrimary" href="https://legal.thomsonreuters.com/en/insights/articles/announcing-westlaw-edge" target="_blank" rel="noopener noreferrer">Read more</a>
        </div>
      </div>
      <div className="projectCont osmd">
        ...
        <div className="rightProject">
          ...
          <a className="buttonPrimary" href="http://open-source-md.net/" target="_blank" rel="noopener noreferrer">Go to site</a>
        </div>
      </div>
      <div className="projectCont cws">
        ...
        <div className="rightProject">
          ...
          <a className="buttonPrimary" href="https://www.cleanwastesystems.com/index.html" target="_blank" rel="noopener noreferrer">Go to site</a>
        </div>
      </div>
    </div>
  )
